    ...
    <nav className="bg-black text-white py-4 shadow-md top-0 left-0 w-full z-50">
      <div className="container mx-auto">
        <ul className="flex justify-center space-x-16 text-lg font-medium">
          ...
          <li>
            <SignedOut>
              <button className="absolute top-10 right-10 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <SignedIn>
              <div className="absolute top-10 right-10 inline-flex h-12 overflow-hidden">
                <UserButton />
              </div>
