      ...
      <div className="relative z-10 max-w-4xl mx-auto bg-white shadow-2xl shadow-gray-400 rounded-xl p-8">
        ...
        <main className="mt-6 text-gray-700">
          ...
          <p className="leading-relaxed mb-6">
            TrailTales is a platform designed for hiking enthusiasts to discover
            trails, share their experiences, and connect with a community of
            nature lovers. Whether you're an experienced hiker or just getting
            started, our app helps you explore new paths and document your
            adventures.
          </p>
          ...
          <ul className="list-disc list-inside space-y-3">
            ...
            <li>
              ...
              See what others are saying about trails and learn from their tips.
            </li>
          </ul>
