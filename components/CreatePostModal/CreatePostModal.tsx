  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      {isUploading ? (
        ...
        <div className="w-full max-w-lg bg-white dark:bg-neutral-900 rounded-lg shadow-lg p-6">
          <h1 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-200 mb-4">
            Share Your Experience!
          </h1>

          <div className="mb-6">
            {/* Pass onFileChange to FileUpload */}
          ...
          <div className="flex justify-end space-x-8">
            <button
              className="w-28 px-4 py-2 rounded-md border border-red-500 text-red-500 hover:bg-red-100 dark:hover:bg-red-900 transition"
              onClick={onCancel}
            >
              Cancel
            </button>
            <button
              className="w-28 px-4 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition"
              onClick={onPost}
            >
              Post
            </button>
